...
if (ext_chromium) {
  ...
  var set_var_sites = ['automobilwoche.de', 'journaldemontreal.com', 'journaldequebec.com', 'lepoint.fr', 'lexpress.fr', 'nzherald.co.nz'];
